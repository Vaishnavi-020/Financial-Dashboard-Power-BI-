# 📊 Financial Performance Dashboard (2-Page Power BI Report)
This repository contains my Financial Performance Dashboard, built using Power BI to analyze the company’s revenue, profit trends, expenses, customer segments, and overall financial health.
The dashboard is designed to give a quick, insightful, and interactive view of the business KPIs and help decision-makers understand how the company is performing across different time periods.

---

# 🚀 Project Overview
The financial dataset includes information about:
...
_📌 Page 1: Financial Overview_

This page gives a top-level summary of the company’s performance.
